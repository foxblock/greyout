...
ControlUnit* LevelLoader::createPlayer(list<PARAMETER_TYPE >& params, Level* const parent, CRint lineNumber)
{
	...
	case pcBlack:
	{
		...
		list<PARAMETER_TYPE > temp;
		temp.push_back(make_pair("collision","black,red"));
		temp.push_back(make_pair("imageoverwrite","images/player/black_big.png"));
		temp.push_back(make_pair("colour","black"));
		temp.push_back(make_pair("tiles","8,9"));
		temp.push_back(make_pair("transparentcolour","255r0g255b"));
		temp.push_back(make_pair("state","default,0,1,10,0,normal"));
		temp.push_back(make_pair("state","stand,0,1,10,0,normal"));
		temp.push_back(make_pair("state","wave,1,3,15,1,pulse"));
		temp.push_back(make_pair("state","fallright,32,7,10,-1,reverse"));
		temp.push_back(make_pair("state","turnright,8,3,10,0,normal"));
		temp.push_back(make_pair("state","pushright,48,7,7,-1,normal"));
		temp.push_back(make_pair("state","runright,16,6,10,-1,pulse"));
		temp.push_back(make_pair("state","jumpright,64,2,10,0,normal"));
		temp.push_back(make_pair("state","flyright,65,1,10,0,normal"));
		temp.push_back(make_pair("state","fallleft,40,7,10,-1,reverse"));
		temp.push_back(make_pair("state","turnleft,11,3,10,0,normal"));
		temp.push_back(make_pair("state","pushleft,56,7,7,-1,normal"));
	...
	{
		list<PARAMETER_TYPE > temp;
		temp.push_back(make_pair("collision","red,white"));
		temp.push_back(make_pair("imageoverwrite","images/player/white_big.png"));
		temp.push_back(make_pair("colour","white"));
		temp.push_back(make_pair("tiles","8,9"));
		temp.push_back(make_pair("transparentcolour","255r0g255b"));
		temp.push_back(make_pair("state","default,0,1,10,0,normal"));
		temp.push_back(make_pair("state","stand,0,1,10,0,normal"));
